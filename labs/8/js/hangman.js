...
function initBoard(){
    for(var letter in selectedWord){
        ...
        $("#hint").append("<span class='hintBtn btn btn-success' id='hint'>Show Hint</button>");
        $(".hint").hide();
}
function pickWord(){
...
//Checks to see if the selected letter esisits in the selectedWord
...
function updateMan(){
    $("#hangImg").attr("src",
    'img/stick_' + (6 - remainingGuesses) + ".png");
}
